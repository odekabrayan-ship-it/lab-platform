        ...
        <nav className="fixed top-0 w-full z-[100] border-b border-white/5 bg-black/60 backdrop-blur-2xl">
          <div className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              <a href={`${process.env.NEXT_PUBLIC_PLATFORM_URL || 'https://lab-platform-kappa.vercel.app'}/login`} className="px-6 py-3 rounded-xl bg-white text-black text-[10px] font-black uppercase tracking-widest hover:bg-indigo-50 transition-all shadow-xl shadow-white/5">
                Portal Access
              </a>
            </div>
          </div>
