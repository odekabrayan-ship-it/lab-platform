      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
        {[
          { 
            ...
            link: (`${process.env.NEXT_PUBLIC_PLATFORM_URL || 'https://lab-platform-kappa.vercel.app'}/login?role=lab`)
          },
          { 
            ...
            link: (`${process.env.NEXT_PUBLIC_PLATFORM_URL || 'https://lab-platform-kappa.vercel.app'}/login?role=client`)
          },
          { 
            ...
            link: (`${process.env.NEXT_PUBLIC_PLATFORM_URL || 'https://lab-platform-kappa.vercel.app'}/login?role=professional`)
          }
        ].map((sys, i) => (
