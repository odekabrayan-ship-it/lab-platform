  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/consumer-hub" element={authed ? <ConsumerHub /> : <Navigate to="/login" />} />
        <Route path="/complete-profile" element={<CompleteProfile />} />
        <Route path="/complete-lab-profile" element={<CompleteLabProfile />} />
        <Route path="/lab-capabilities" element={<LabCapabilities />} />

        <Route element={authed ? <NavLayout /> : <Navigate to="/login" replace />}>
          ...
          <Route path="/hr/professionals" element={<HRDashboard />} />
